...
SettingsDialog::SettingsDialog(Logger_Logger::IHM_Logger *parent) :
    QDialog(parent),
...
Logger_Logger::Logger::Settings SettingsDialog::settings() const
{
...
void SettingsDialog::apply()
{
    ...
    {
     ((Logger_Logger::IHM_Logger *)parentWidget())->applySettings();
     parentWidget()->show();
    }
}
